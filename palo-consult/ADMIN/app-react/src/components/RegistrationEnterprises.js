                            ...
                            <div id="signup">
                                <form onSubmit={this.handleSubmit} method="POST" className="form">
                                    ...
                                    <p className="fieldset">
                                        ...
                                        <input id="signup-vatNumber" className="input-register"  placeholder='VAT Number' name='vatNumber' ref={vatNumber=>this.vatNumber=vatNumber}/>
                                        </p>
                                    <p className="fieldset">
                                        <label>Activity </label>
                                        <select id="signup-activity" className="input-register"  name='activity 'ref={activity=>this.activity=activity}>
                                    ...
                                    <p className="fieldset">
                                        <label>Country </label>
                                        <select id="signup-country" className="input-register"  name='country' ref={country=>this.country=country}>
                                    ...
                                    <p className="fieldset">
                                        ...
                                        <input  id="signup-contactPerson" className="input-register"  placeholder='Contact Person' name='contactPerson' ref={contactPerson=>this.contactPerson=contactPerson}/>
                                    </p>
                                    <p className="fieldset">
