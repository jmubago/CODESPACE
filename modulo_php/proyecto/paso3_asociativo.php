...
/**
 * 1. Crear un array indexado que contenga todos los usuarios de nuestra aplicaciòn.
 * Mostrar el listado de usuarios usando un bucle
 * 
 * 2. Probar el mismo ejemplo con una array asociativo
 */
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <table class='table table-bordered table-striped'>
                        ...
                        <tbody>
                             <?php foreach ($usuarioDatos as $usuario) {
                            ;?>
                            <tr>
