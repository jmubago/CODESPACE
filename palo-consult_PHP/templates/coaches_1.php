                          ...
                          <div class="card-body">
                              <div class="row">
                                <div class="col-sm-5">  
                                    ...
                                    <a class="btn btn-primary" data-toggle="collapse" href="?verId=<?php echo $usuario_usuarios["id"]?>" role="button" aria-expanded="false" aria-controls="multiCollapseExample1">See + info</a>
                                </div>
                                <div class="col-sm-5">
